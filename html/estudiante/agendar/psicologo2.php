...
<body>
    ...
    <div class="container">
        <div class="row mt-3">
            <div class="col-lg-8">
                <p class="fs-1 text-center">Sonya Pedroso - Licenciada en psicología</p>

                <form class="" action="../../../database/orientacion2.php" method="POST" id="formOrientacion">
                    <div class="mb-3 row">
            ...
            <div class="col-lg-4 mt-3 text-center">
                <img src="../../../img/ejemplo 2.jpg" class="img-thumbnail" alt="..." style="width: 15rem;">
            </div>
        </div>
    </div>
