...
<body>
  ...
  <div class="container shadow-lg">
    <div class="row my-4 mt-4">
      <div class="col-lg-3 col-sm-6 col-12 d-grid gap-2 my-4">
      ...
      <div class="col-lg-3 col-sm-6 col-12 d-grid gap-2 my-4">
        <div class="card" style="width: 15rem;">
          <img src="../../img/ejemplo 3.jpg" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title">Amanda Bermudes</h5>
            <p class="card-text">Psicopedagogo. Temas de consulta: Orientacion academica. Desarrollo del aperendizaje.
            </p>
      ...
      <div class="col-lg-3 col-sm-6 col-12 d-grid gap-2 my-4">
        <div class="card" style="width: 15rem;">
          <img src="../../img/ejemplo 4.jpg" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title">Renata Elina</h5>
            <p class="card-text">Psicologia clinica. Temas de consulta: Manejo de Terapia Breve. depresión, ansiedad,
