...
<body>
  ...
  <div class="container shadow-lg my-5">
    ...
    <div class="row mx-5">
      <p class="fs-3 text-center mt-2">Solicitudes en espera</p>
          ...
          <tbody id="tablacontenidoContacto">
            <?php 
              ...
              while($mostrar = mysqli_fetch_array($resultado)){
                if ($mostrar['estado'] == 'Esperando aprobación') {
              ?>
            ...
            <tr>
              ...
              <td>
                <div class="d-grid gap-2 d-md-block">
                  <button method="POST" type="button" class="btn btn-outline-warning" data-bs-toggle="modal"
                    data-bs-target="#editsModal<?php echo $mostrar['codigo']; ?>" name="btt-edit">Editar</button>
    ...
    <div class="row mx-5">
      <p class="fs-3 text-center mt-2">Solicitudes aceptadas</p>
      <div class="col-lg-12 table-bordered table-responsive">
        <table class="table text-center" id="tablaContacto">
          <thead class="">
            <tr>
